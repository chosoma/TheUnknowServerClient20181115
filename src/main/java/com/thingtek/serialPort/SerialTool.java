...
import com.thingtek.serialException.*;
...
public class SerialTool {
    ...
    public Vector<String> findPort() {
        ...
        while (portList.hasMoreElements()) {
            ...
            /*System.out.println(port.getCurrentOwner());
     ...
     */
    public SerialPort openPort(String portName, int baudrate) throws SerialPortParameterFailure, NotASerialPort, NoSuchPort, PortInUse, NoSuchPortException, PortInUseException {
